  ...
  return (
    <div className="w-full  overflow-x-hidden h-full bg-black overflow-y-auto no-scrollbar  flex flex-col gap-2 bg-fit px-1 py-1 ">
      <div className="w-full min-h-[120%]  flex flex-col">{
        chats.length < 1 && <h1 className="text-xl text-white font-bold">
  No chats found yet! 
  <br />
  1. Send a request in the <span className="text-blue-400">Search🔍</span> section. 
  <br />
  2. Or accept pending requests in the <span className="text-blue-400">Notifications🔔</span> section.
</h1>
